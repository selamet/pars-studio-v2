      ...
      <div className="hero-vignette relative z-10 flex h-full flex-col justify-between px-[clamp(20px,4vw,64px)] py-[clamp(80px,12vh,140px)]">
        ...
        <div className="mx-auto w-full max-w-page">
          ...
          <h1 className="max-w-title font-serif font-light leading-[0.96] tracking-[-0.018em] text-[clamp(54px,9.6vw,160px)]">
            ...
            {/* The colored word lives on its own bigger, single-line band at the
                bottom, so the static lines above never reflow when it swaps.
                Bottom padding gives descenders room; the negative margin keeps
                the line spacing tight to its own size. */}
            <RotatingWord
              words={titleWords}
