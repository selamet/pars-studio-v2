...
export default function WhatsappButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center bg-[#25D366] text-white shadow-[0_8px_28px_-6px_rgba(37,211,102,0.5)] ring-1 ring-white/10 transition-all duration-300 hover:scale-105 hover:bg-[#1ebe5d] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent sm:bottom-7 sm:right-7 sm:h-[58px] sm:w-[58px]"
